...
// const LoginForm: FC<LoginFormProps> = ({ user = UserModel, setUser, handleLogin, handleLogout }) => {
...
// 				/>
// 			</div>
// 			<button className="bg-blue-500 text-white p-2 rounded-md w-full" onClick={handleLogin}>
// 				Log in
// 			</button>
